...
python main.py --configs configs/NCI1/gnn-transformer/gd=128+gdp=0.1+tdp=0.1+l=3+cosine.yml
python main.py --configs configs/NCI1/gnn-transformer/gin+gdp=0.1+tdp=0.1+l=4+cosine.yml
...
python main.py --configs configs/NCI109/gnn-transformer/gd=128+gdp=0.1+tdp=0.1+l=3+cosine.yml
python main.py --configs configs/NCI109/gnn-transformer/gin+gdp=0.1+tdp=0.1+l=4+cosine.yml
